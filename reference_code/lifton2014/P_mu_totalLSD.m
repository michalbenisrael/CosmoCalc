function out = P_mu_totalLSD(z,h,Rc,SPhi,consts,nuclide,dflag)

% Calculates the production rate of Al-26, Be-10, or 14C 
% (nuclide = 26, 10, 14, respectively) by muons
% as a function of depth below the surface z (g/cm2) and
% site atmospheric pressure h (hPa), cutoff rigidity Rc (GV), and 
% solar modulation parameter SPhi (MV).
% 
% syntax out = P_mu_totalLSD(z,h,Rc,SPhi,consts,nuclide,dflag)
%
% consts is a structure containing nuclide-specific constants (typically called
% from consts_LSD.mat), as follows:
